    ...
    >
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <nav className="space-y-1">
            ...
            <button
              onClick={() => onNavigate('dashboard')}
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-all"
            >
      ...
      <div className="bg-gradient-to-br from-teal-50/80 to-slate-50 border border-teal-200/70 rounded-2xl p-3.5 space-y-2.5 shadow-xs">
        ...
        <button
          ...
          className="w-full py-2 px-3 bg-slate-900 hover:bg-slate-800 text-white rounded-xl text-xs font-bold transition-colors shadow-xs"
        >
          Launch Planner
        </button>
      </div>
