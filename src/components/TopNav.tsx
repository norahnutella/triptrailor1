...
export const TopNav: React.FC<TopNavProps> = ({
  ...
  return (
    <header className="h-16 bg-white border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between gap-4 shrink-0 select-none z-20 sticky top-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-1.5 px-3.5 py-2 bg-orange-600 hover:bg-orange-700 text-white text-xs font-bold rounded-xl transition-colors cursor-pointer shadow-xs"
        >
